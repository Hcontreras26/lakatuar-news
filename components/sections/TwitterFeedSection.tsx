...
export function TweetCard({ tweet }: { tweet: TweetPost }): React.JSX.Element {
  return (
    <article className="flex flex-col justify-between rounded-2xl border border-zinc-800 bg-[#09090b] p-4 text-zinc-100 shadow-md transition hover:border-zinc-700 sm:p-5">
      <div>
        {/* Cabecera del Tweet */}
