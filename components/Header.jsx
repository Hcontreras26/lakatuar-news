// Componente de navegación principal para la marca.
// Mantiene la estructura clara para futuras integraciones con CMS o rutas dinámicas.
const navItems = [
...
function SocialIcon({ type }) {
  const commonClasses = "h-4 w-4 fill-current";

  switch (type) {
    case "facebook":
      return (
        <svg viewBox="0 0 24 24" className={commonClasses} aria-hidden="true">
...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 border-b border-red-900/60 bg-[#120404]/95 backdrop-blur-sm">
