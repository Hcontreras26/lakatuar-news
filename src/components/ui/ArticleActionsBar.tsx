...
export default function ArticleActionsBar({
  ...
  return (
    <>
      {/* Botones de Acción Editorial (Escuchar, Puntos clave, Resumen) */}
      <div className="flex flex-wrap items-center gap-2 py-3 border-y border-red-950/60 bg-[#160405]/60 px-3 rounded-xl backdrop-blur-sm">
        {/* Botón Escuchar */}
        <button
          type="button"
          onClick={toggleAudio}
          className={`inline-flex items-center gap-2 rounded-lg px-3 py-1.5 text-xs font-bold transition-all ${
            isPlayingAudio
              ...
              : "bg-red-950/80 border border-red-800/60 text-red-300 hover:bg-red-900/60 hover:text-white"
          }`}
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg border border-red-950/80 bg-black/40 px-3 py-1.5 text-xs font-semibold text-zinc-300 transition hover:border-red-700/60 hover:bg-red-950/40 hover:text-white"
        >
          <svg className="h-3.5 w-3.5 text-yellow-500 fill-current" viewBox="0 0 24 24">
      ...
      {activeModal === "points" && (
        <div className="mt-3 rounded-xl border border-yellow-900/50 bg-gradient-to-r from-yellow-950/20 via-[#180506] to-black p-4 text-zinc-200 shadow-xl animate-fadeIn">
          <div className="flex items-center justify-between border-b border-yellow-900/40 pb-2 mb-3">
            <div className="flex items-center gap-2">
              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-yellow-500/20 text-yellow-500 text-xs font-bold">
                ⚡
              </span>
      ...
      {activeModal === "summary" && (
        <div className="mt-3 rounded-xl border border-red-900/50 bg-gradient-to-r from-red-950/20 via-[#180506] to-black p-4 text-zinc-200 shadow-xl animate-fadeIn">
      ...
      {/* Barra de Compartir con Redes Sociales y Copiar Enlace */}
      <div className="mt-4 flex flex-wrap items-center justify-between gap-3 border-b border-red-950/60 pb-3 text-xs text-zinc-400">
        <div className="flex items-center gap-2">
          <span className="font-semibold text-zinc-300">Compartir:</span>
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full border border-red-950 bg-[#1e0608] text-zinc-300 transition hover:border-emerald-500 hover:bg-emerald-600 hover:text-white"
          >
          ...
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full border border-red-950 bg-[#1e0608] text-zinc-300 transition hover:border-blue-500 hover:bg-blue-600 hover:text-white"
          >
            <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full border border-red-950 bg-[#1e0608] text-zinc-300 transition hover:border-zinc-400 hover:bg-black hover:text-white"
          >
            <svg className="h-3.5 w-3.5 fill-current" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full border border-red-950 bg-[#1e0608] text-zinc-300 transition hover:border-blue-400 hover:bg-blue-700 hover:text-white"
          >
            <svg className="h-3.5 w-3.5 fill-current" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full border border-red-950 bg-[#1e0608] text-zinc-300 transition hover:border-sky-400 hover:bg-sky-600 hover:text-white"
          >
            <svg className="h-3.5 w-3.5 fill-current" viewBox="0 0 24 24">
          ...
          <button
            ...
            title="Copiar enlace"
            className="flex h-8 w-8 items-center justify-center rounded-full border border-red-950 bg-[#1e0608] text-zinc-300 transition hover:border-red-500 hover:text-red-400"
          >
            {copied ? (
