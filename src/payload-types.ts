...
export interface Article {
  ...
  title: string;
  /**
   * Se genera automáticamente a partir del titular.
   */
  slug?: string | null;
  summary: string;
...
export interface Category {
   ...
   */
  slug?: string | null;
  color?: ('blue' | 'red' | 'green' | 'orange' | 'purple' | 'gray') | null;
...
export interface Denuncia {
  ...
  category?: ('servicios_publicos' | 'ddhh' | 'corrupcion' | 'salud' | 'seguridad' | 'otro') | null;
  description: string;
  attachments?: (number | Media)[] | null;
  status?: ('new' | 'in_review' | 'investigating' | 'published' | 'dismissed') | null;
...
export interface SiteSetting {
  ...
  denunciasBannerText?: string | null;
