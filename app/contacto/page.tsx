...
export default function ContactoPage(): React.JSX.Element {
  return (
    <div className="min-h-screen bg-[#120404] text-white flex flex-col justify-between">
      ...
      <main className="flex-1 mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 w-full">
        {/* Breadcrumbs */}
        <nav aria-label="Ruta de navegación" className="mb-6 flex items-center gap-2 text-xs text-zinc-400">
          ...
          <span className="font-semibold text-red-400">Contacto y Denuncias</span>
        </nav>

        {/* Hero Section */}
        <div className="relative mb-12 overflow-hidden rounded-2xl border border-red-900/40 bg-gradient-to-r from-black via-[#1f0507] to-black p-6 sm:p-10 shadow-2xl">
          <div className="absolute top-0 right-0 -mt-10 -mr-10 h-56 w-56 rounded-full bg-red-600/10 blur-3xl pointer-events-none" />
          <div className="relative z-10 max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded bg-red-600 px-2.5 py-1 text-[10px] font-black uppercase tracking-widest text-white shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 mb-12">
          ...
          <div className="space-y-6 lg:col-span-5">
            <div className="rounded-xl border border-red-950 bg-[#160404]/70 p-5">
              ...
              <div className="space-y-4">
                {directChannels.map((ch) => (
                  <div
                    key={ch.title}
                    className="rounded-xl border border-red-900/30 bg-[#1a0505]/60 p-4 transition duration-200 hover:border-red-600/50 hover:bg-[#200707]/70"
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex items-center gap-2.5">
                        <div className="rounded-lg bg-black/40 p-2 border border-red-950">
                          {ch.icon}
                        </div>
                    ...
                    <div className="mt-3 border-t border-red-900/20 pt-2.5">
                      <a
                        href={ch.contactHref}
            ...
            <div className="rounded-xl border border-zinc-900 bg-black/40 p-5">
              <h3 className="text-xs font-black uppercase tracking-wider text-zinc-300 mb-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <a
                  ...
                  className="flex items-center gap-2 rounded-lg border border-red-900/40 bg-[#160404] px-3 py-2 text-zinc-200 transition hover:border-red-500 hover:text-white"
                >
        ...
        <div className="mt-12 rounded-2xl border border-red-950 bg-[#140303]/60 p-6 sm:p-8">
          <div className="mb-6">
            <span className="rounded bg-red-950 px-2.5 py-1 text-[10px] font-black uppercase tracking-widest text-red-400 border border-red-900/50">
              GUÍA DE ENVÍO
            </span>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {faqs.map((faq, idx) => (
              <div
                key={idx}
                className="rounded-xl border border-red-900/30 bg-black/40 p-4 transition hover:border-red-700/50"
              >
